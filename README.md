...
Transferir Valor: Permite retirar um valor da conta (com validação de saldo insuficiente).

Receber Valor: Permite adicionar um valor ao saldo atual.
...
Plaintext
***********************
Nome do cliente: Gustavo Cardoso
Tipo de conta: Corrente
Saldo na conta: 1599.99
***********************
